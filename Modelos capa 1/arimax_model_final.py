...
for order in orders:
    ...
    for trend in trends:
        ...
        print(f"\nEvaluando ARIMAX order={order} | trend={trend}")
        ...
        for train_idx, test_idx in tscv.split(X):
            ...
            try:
                ...
                print(
                    f"Error con order={order}, trend={trend}: {e}"
                )
...
# Ordenar por MAPE test
results_df = results_df.sort_values(
    "MAPE_test"
).reset_index(drop=True)

print("\nRESULTADOS GRID SEARCH ARIMAX")
print(results_df)
...
print(
    "\nTabla guardada como: arimax_grid_search_results.csv"
)
# ============================================================
...
# Se usa fittedvalues para medir ajuste dentro de muestra.
y_pred_train_final = best_result.fittedvalues
...
y_pred_test_final = forecast_final.predicted_mean
...
final_metrics_df = pd.DataFrame({
    "dataset": ["train", "test"],
    "MAE": [metrics_train_final["MAE"], metrics_test_final["MAE"]],
    "MAPE": [metrics_train_final["MAPE"], metrics_test_final["MAPE"]],
    "RMSE": [metrics_train_final["RMSE"], metrics_test_final["RMSE"]]
})

print("\nARIMAX FINAL RESULTS TRAIN / TEST")
print(final_metrics_df)

final_metrics_df.to_csv("arimax_final_train_test_metrics.csv", index=False)
print("\nMétricas finales guardadas como: arimax_final_train_test_metrics.csv")
# ============================================================
# 13. GRÁFICO FINAL
# ============================================================
