...
# ============================================================
# 17. SELECCIÓN MEJOR MODELO LIGHTGBM
# ============================================================
...
y_pred_validation_lgbm = best_lgbm_model.predict(
    X_validation
)
# ============================================================
...
mae_val_lgbm = mean_absolute_error(
    y_validation,
    y_pred_validation_lgbm
)

rmse_val_lgbm = np.sqrt(
    mean_squared_error(
        y_validation,
        y_pred_validation_lgbm
    )
...
r2_val_lgbm = r2_score(
    y_validation,
    y_pred_validation_lgbm
)

mape_val_lgbm = np.mean(
    np.abs(
        (y_validation - y_pred_validation_lgbm)
        / y_validation
    )
) * 100

print("\nLIGHTGBM FINAL RESULTS")
print("MAE:", mae_val_lgbm)
print("RMSE:", rmse_val_lgbm)
print("R²:", r2_val_lgbm)
print("MAPE:", mape_val_lgbm)
# ============================================================
# 21. REAL VS PREDICHO
# ============================================================
...
plt.barh(
    ...
    top_features_lgbm["importance"]
)

plt.title(
    "LightGBM Tuned - Top 15 Features",
    fontsize=16,
    fontweight="bold"
)
